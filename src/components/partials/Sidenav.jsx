...
const Sidenav = () => {
    return (
        <div className="w-[20%] h-full  border-r-2 border-zinc-400 p-10  overflow-y-scroll">
            ...
            <nav className="flex flex-col text-zinc-400 text-xl gap-3">
                ...
                <Link className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg  text-nowrap p-5 ">
