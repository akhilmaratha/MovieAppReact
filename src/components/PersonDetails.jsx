...
const PersonDetails = () => {
  ...
  return info ? (
    <div className="px-[5%] pb-[15%] w-screen h-fit bg-[#1F1E24] overflow-x-hidden">
      {/* Part 1 navigation */}
      ...
      <div className="w-full ">
        <div className="sm:w-[100%] w-full flex sm:flex-row  flex-col justify-evenly">
            <div className="row ">
             <img
            className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] sm:h-[50vh] object-cover mx-auto "
            src={`https://image.tmdb.org/t/p/original/${info.detail.profile_path}`}
            alt=""
          />
          {/* Social Media Links */}
          <div className="text-2xl text-white flex gap-x-5 py-10">
            <a
              target="_blank"
      ...
      <div className="row ">
        <h1 className="mt-5 text-2xl text-zinc-400 font-semibold ">Known For</h1>
